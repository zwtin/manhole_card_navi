...
mixin _$MapMarkerDTO {
 ...
 String get cardId;/// カード画像の Firebase Hosting 上のパス。
 String get imagePath; String get distributionState; double get latitude; double get longitude;
...
@override
int get hashCode => Object.hash(runtimeType,cardId,imagePath,distributionState,latitude,longitude);
...
@useResult
$Res call({
 String cardId, String imagePath, String distributionState, double latitude, double longitude
});
...
/// Create a copy of MapMarkerDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cardId = null,Object? imagePath = null,Object? distributionState = null,Object? latitude = null,Object? longitude = null,}) {
...
class _MapMarkerDTO extends MapMarkerDTO {
  const _MapMarkerDTO({required this.cardId, required this.imagePath, required this.distributionState, required this.latitude, required this.longitude}): super._();
...
/// Create a copy of MapMarkerDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cardId = null,Object? imagePath = null,Object? distributionState = null,Object? latitude = null,Object? longitude = null,}) {
