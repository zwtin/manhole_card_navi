...
/// @nodoc
abstract class $ManholeCardContactCopyWith<$Res> {
  factory $ManholeCardContactCopyWith(
          ManholeCardContact value, $Res Function(ManholeCardContact) then) =
      _$ManholeCardContactCopyWithImpl<$Res, ManholeCardContact>;
  @useResult
  $Res call(
      {String address,
      String id,
...
/// @nodoc
class _$ManholeCardContactCopyWithImpl<$Res, $Val extends ManholeCardContact>
    implements $ManholeCardContactCopyWith<$Res> {
  _$ManholeCardContactCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_ManholeCardContactCopyWith<$Res>
    implements $ManholeCardContactCopyWith<$Res> {
  factory _$$_ManholeCardContactCopyWith(_$_ManholeCardContact value,
          $Res Function(_$_ManholeCardContact) then) =
      __$$_ManholeCardContactCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String address,
...
/// @nodoc
class __$$_ManholeCardContactCopyWithImpl<$Res>
    extends _$ManholeCardContactCopyWithImpl<$Res, _$_ManholeCardContact>
    implements _$$_ManholeCardContactCopyWith<$Res> {
  __$$_ManholeCardContactCopyWithImpl(
      _$_ManholeCardContact _value, $Res Function(_$_ManholeCardContact) _then)
      : super(_value, _then);
...
class _$_ManholeCardContact extends _ManholeCardContact {
  const _$_ManholeCardContact(
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_ManholeCardContact &&
  ...
  _$$_ManholeCardContactCopyWith<_$_ManholeCardContact> get copyWith =>
      __$$_ManholeCardContactCopyWithImpl<_$_ManholeCardContact>(
          this, _$identity);
}

abstract class _ManholeCardContact extends ManholeCardContact {
  const factory _ManholeCardContact(
