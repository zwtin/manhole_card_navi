...
/// @nodoc
abstract class _$$_DetailCardViewDataCopyWith<$Res>
    implements $DetailCardViewDataCopyWith<$Res> {
  factory _$$_DetailCardViewDataCopyWith(_$_DetailCardViewData value,
          $Res Function(_$_DetailCardViewData) then) =
      __$$_DetailCardViewDataCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$_DetailCardViewDataCopyWithImpl<$Res>
    extends _$DetailCardViewDataCopyWithImpl<$Res, _$_DetailCardViewData>
    implements _$$_DetailCardViewDataCopyWith<$Res> {
  __$$_DetailCardViewDataCopyWithImpl(
      _$_DetailCardViewData _value, $Res Function(_$_DetailCardViewData) _then)
      : super(_value, _then);
...
class _$_DetailCardViewData extends _DetailCardViewData {
  const _$_DetailCardViewData(
      {required this.id,
      required this.icon,
      required this.name,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_DetailCardViewData &&
  ...
  _$$_DetailCardViewDataCopyWith<_$_DetailCardViewData> get copyWith =>
      __$$_DetailCardViewDataCopyWithImpl<_$_DetailCardViewData>(
          this, _$identity);
}
